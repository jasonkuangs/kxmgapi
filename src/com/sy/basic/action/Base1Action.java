...
import com.sy.basic.obj.ResultJsonObject1;
...
public class Base1Action extends ActionSupport implements ServletResponseAware, ServletRequestAware {
    ...
    protected ResultJsonObject1<Object> result = new ResultJsonObject1<Object>();// 分页对象
    ...
    public ResultJsonObject1<Object> getResult() {
	return result;
    }
}
